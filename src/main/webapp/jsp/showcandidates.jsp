...
<c:forEach var="Ehdokkaat" items="${requestScope.candidateList}">
	<div class="flex-container">
		<div class="flex-child">
			<h2>
				<b>${Ehdokkaat.ehdokasId}:</b> ${Ehdokkaat.etunimi}
				${Ehdokkaat.sukunimi}
			</h2>
			<b>Puolue: </b><br> ${Ehdokkaat.puolue} <br> <b>Kotipaikkakunta:</b><br>
			${Ehdokkaat.kotipaikkakunta}<br> <b>Ikä: </b><br>
			${Ehdokkaat.ika}<br> <b>Ammatti:</b><br>
			${Ehdokkaat.ammatti}<br> <b>Miksi haluat eduskuntaan?</b><br>
			${Ehdokkaat.miksiEduskuntaan}<br> <b>Mitä asioita haluat
				edistää?</b><br> ${Ehdokkaat.mitaAsioitaHaluatEdistaa}<br>
		</div>
		<div class="flex-child">
			<c:choose>
